...
public class Travels {
    ...
    public static boolean mountDragon(Player player) {
        ...
        // Spawning XemDragon
        net.minecraft.server.v1_6_R2.World notchWorld = ((CraftWorld) player.getWorld()).getHandle();
    ...
    /**
     * Land the dragon and dismount the player safely.
     * <p />
     * Updates the HashMap "TravelInformation" accordingly.
     *
     * @param entity the XemDragon entity
     * @param dest the landing destination
     */
    public static void landDragon(Entity entity, Location dest) {
    ...
    /**
     * Dismounts the player and removes the dragon from the world.
     * <p />
     * Updates the HashMap "TravelInformation" accordingly.
     * 
     * @param entity the XemDragon entity
